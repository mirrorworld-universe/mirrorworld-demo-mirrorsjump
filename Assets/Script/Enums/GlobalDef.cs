...
public class GlobalDef 
{
    ...
    public static int ReviewVersionCode = 3;//这里要对比AWS上的配置文件的ReviewCode来写，规则是每次发布自增1
    ...
    //DevnetCollection
    public static string ParentCollectionDevNet = "6Gjohc4p7YBRig6w756CxXDz3uuFprN1mv4bZeZ3XF4S";//"DUuMbpmH3oiREntViXfGZhrLMbVcYBwGeBa4Wn9X8QfM";
    public static string UserCollection = ParentCollectionMainNet;
    public static bool IsMainNet = true;
    // market 路径标识枚举
    public static MirrorEnv Env = MirrorEnv.Mainnet;
